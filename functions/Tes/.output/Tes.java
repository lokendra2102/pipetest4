...
public class Tes implements CatalystCronHandler {

	private static final Logger LOGGER = Logger.getLogger(Tes.class.getName());
	...
	public CRON_STATUS handleCronExecute(CronRequest request, Context arg1) throws Exception {
		try {
			...
			ZCCache.getInstance().putCacheValue("Tes", "Working", 1l);
