...
public class CronJava implements CatalystCronHandler {

	private static final Logger LOGGER = Logger.getLogger(CronJava.class.getName());
	...
	public CRON_STATUS handleCronExecute(CronRequest request, Context arg1) throws Exception {
		try {
			...
			ZCCache.getInstance().putCacheValue("CronJava", "Working", 1l);
