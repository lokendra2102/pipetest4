...
def handler(request: Request):
    ...
    if request.path == "/":
        zia = app.zia()
        sentimentAnalysis = zia.get_sentiment_analysis(['I like coffee'],['coffee'])
        keywordExtraction = zia.get_keyword_extraction(['I like coffee'])
        nerPrediction = zia.get_NER_prediction(['I like coffee'])
